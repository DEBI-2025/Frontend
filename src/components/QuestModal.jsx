  ...
  return (
    <Overlay>
      ...
      >
        ...
        <OptionText>Which interview are you preparing for?</OptionText>
        ...
        <OptionsContainer>
          ...
          <OptionButton
            bgColor="#F7C5CC59"
            onClick={() => handleNavigate("/hr-questions")}
          >
            <Img src={MindPhoto} alt="Mind Photo" />
            <TextWrapper>HR & Behavioral</TextWrapper>
          </OptionButton>
          <OptionButton
            bgColor="#C3A2F380"
            onClick={() => handleNavigate("/technical-questions")}
          >
            <Img src={Technical} alt="Technical Photo" />
            <TextWrapper>Technical</TextWrapper>
          </OptionButton>
        </OptionsContainer>
      </ModalContainer>
    </Overlay>
